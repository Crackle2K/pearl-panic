...
class Player(Sprites):
    ...
    def __init__(self, x=120, y=120, screen_width=680, screen_height=480):
        ...
        player_image = pygame.image.load("assets/images/diver.png").convert()
...
class Shark(Obstacle):
    def __init__(self):
        ...
        shark_img = pygame.image.load("assets/images/shark.png").convert()
...
class Jellyfish(Obstacle):
    def __init__(self):
        ...
        jelly_img = pygame.image.load("assets/images/jellyfish.png").convert()
...
class Current(Obstacle):
    def __init__(self):
        ...
        current_img = pygame.image.load("assets/images/current.png").convert()
